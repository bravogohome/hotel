 ...
 */
@Service
public class RoomstandardServiceImpl extends ServiceImpl<RoomstandardMapper, Roomstandard> implements RoomstandardService {
    @Autowired
    ...
    public Map<String,Object> getRestRoom(LocalDate startDay, LocalDate endDay){
        ...
        List<Roomstandard> allRoom=roomstandardMapper.findAll();
