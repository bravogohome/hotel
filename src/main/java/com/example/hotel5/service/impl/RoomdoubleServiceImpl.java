...
import com.example.hotel5.mapper.RoomdoubleMapper;
 ...
 */
@Service
public class RoomdoubleServiceImpl extends ServiceImpl<RoomdoubleMapper, Roomdouble> implements RoomdoubleService {
    @Autowired
    RoomdoubleMapper roomdoubleMapper;
    @Autowired
    ...
    public Map<String,Object> getRestRoom(LocalDate startDay,LocalDate endDay){
        ...
        List<Roomdouble> allRoom=roomdoubleMapper.findAll();
